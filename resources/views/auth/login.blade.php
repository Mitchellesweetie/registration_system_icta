                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @endif
                                ...
                                <div class="form-body">
                                 <form class="row g-3" method="POST" action="{{ route ('authlogin')}}">
                                    @csrf
                                        ...
                                        <div class="col-md-6 text-end"> <a href="{{route('forgetpassword')}}">Forgot Password ?</a>
                                        </div>
                                        <div class="col-12">
                                            <div class="d-grid">
