...
{{--           
          ...
          <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <select id="eventSelect" class="form-select" aria-label="Select your Event" style="flex: 1; max-width: 70%;" onchange="updateDownloadLink()">
              <option selected>Select Your Events</option>
            ...
            <!-- Add Event Button -->
            <div class="create-user-button" style="margin-left: 2px;">
              <!-- Button to trigger the modal -->
              <a id="downloadLink" href="#" style="text-decoration: none; background:#0d6efd;color: white; display: flex; align-items: center;" class="btn btn-primary">
          ...
          <script>
            function updateDownloadLink() {
              ...
              // Get the download link and update the href with the selected event ID
              var downloadLink = document.getElementById('downloadLink');
              if (selectedEventId) {
                downloadLink.href = '/download/' + selectedEventId;
              } else {
                downloadLink.href = '#'; // If no event is selected, keep the link empty
              }
            }
          </script>
